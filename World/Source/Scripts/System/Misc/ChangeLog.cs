		...
		private static void AppendRelease(StringBuilder builder, int releaseIndex)
		{
			switch (releaseIndex)
			{
				...
				case 12:
					...
					builder.Append("- Command - '[Help' command has been renamed to '[Commands'<br>");
					builder.Append("- Command - Add '[Help' command to open the help gump<br>");
					...
					builder.Append("- Gump - Stable gump now reopens after claiming a pet when you have more stabled pets<br>");
					...
					builder.Append("- Preference - Defaultly show weapon ability names<br>");
					...
					builder.Append("- Admin - `S_FoodCheck` setting is now respected<br>");
					builder.Append("- Admin - `S_SkillGain` setting is now respected<br>");
					...
					builder.Append("- Gump - Death Knight and Holy Man spells now work when cast via their [toolbars<br>");
					...
					builder.Append("- Misc - Fix issue where non-tempted Players had their soul orbs being deleted every restart<br>");
				...
				case 13:
					...
					builder.Append("- Item - Increased base cost for Magery Spellbooks to 100 per, up from 18<br>");
					...
					builder.Append("       - Casting success chance is determined by the higher value between Inscription and Spell skill<br>");
