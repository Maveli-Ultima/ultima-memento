...
namespace Server.Spells.Song
{
	public class EnergyThrenodySong : Song
	{
		public static readonly SpellInfo SpellInfo = new SpellInfo(
			new SpellDefinition
			{
				SpellID = 354,
				IconGraphic = 0x407,
				Name = "Energy Threnody",
				PowerWords = "*plays an energy threnody*",
				Description = "Lowers the energy resistance of your target.",
				ManaCost = 25,
				MinSkill = 70,
	...
	-1
		...
		public EnergyThrenodySong(Mobile caster, Item scroll) : base(caster, scroll, SpellInfo)
		{
		}
