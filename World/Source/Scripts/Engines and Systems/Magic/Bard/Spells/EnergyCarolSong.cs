...
namespace Server.Spells.Song
{
	public class EnergyCarolSong : Song
	{
		public static readonly SpellInfo SpellInfo = new SpellInfo(
			new SpellDefinition
			{
				...
				IconGraphic = 0x406,
				Name = "Energy Carol",
				PowerWords = "*plays an energy carol*",
				Description = "An area of effect that raises the energy resistance of your party.",
				ManaCost = 12,
				MinSkill = 50,
	...
	-1
		...
		public EnergyCarolSong(Mobile caster, Item scroll) : base(caster, scroll, SpellInfo)
		{
		}
